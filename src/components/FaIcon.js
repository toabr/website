...
export default function FaIcon({ name = '', className }) {
  switch (name.toLowerCase()) {
    ...
    case 'arrowleft': return <ArrowIcon />
    case 'arrowright': return <ArrowIcon />
