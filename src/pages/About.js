  ...
  return (
    <div id="about" className="d-flex flex-column justify-content-center text-light p-3">
      ...
      <footer className="position-fixed bottom-0">
        <p className="">Photo by <a rel="noreferrer" target="_blank" href="https://unsplash.com/@hikendal?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Kendal</a> on <a rel="noreferrer" target="_blank" href="https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
        </p>
      </footer>
    </div>
  )
